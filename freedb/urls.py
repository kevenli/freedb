...
urlpatterns = [
    ...
    path('api/databases/<slug:db_name>/collections', views.DatabaseCollectionList.as_view(),
         name='api_db_collections'),
    path('api/databases/<slug:db_name>/collections/<slug:col_name>/fields', views.DatabaseCollectionFieldsView.as_view(),
         name='api_db_collection_fields'),
    path('api/databases/<slug:db_name>/collections/<slug:col_name>', views.DatabaseCollectionInstance.as_view(),
         name='api_db_collection'),
    path('api/databases/<slug:db_name>/collections/<slug:col_name>/documents', views.DatabaseCollectionDocuments.as_view(),
         name='api_db_collection_docs'),
    path('api/databases/<slug:db_name>/collections/<slug:col_name>/documents:batchsave', views.DatabaseCollectionDocumentsBatchSave.as_view(),
         name='api_db_collection_docs_batchsave'),
    path('api/databases/<slug:db_name>/collections/<slug:col_name>/documents:sync', views.DatabaseCollectionDocumentsSync.as_view(),
         name='api_db_collection_docs_sync'),
    path('api/databases/<slug:db_name>/collections/<slug:col_name>/documents:import', views.DatabaseCollectionDocumentsImport.as_view(),
         name='api_db_collection_docs_import'),
    path('api/databases/<slug:db_name>/collections/<slug:col_name>/documents/<path:doc_id>', 
